...
<head>
  ...
  <!-- <script src="https://www.google.com/recaptcha/api.js?render=6LdP6K8dAAAAAAYVNcnJ20Wbcu7ZW2SfSmsrFguQ"></script> -->
  <style>
			...
			<div class="page-content d-flex align-items-center justify-content-center">
                ...
                <div class="col-md-12 pl-md-0">
                  <div class="auth-form-wrapper px-5 py-5">
					  <img class="mx-auto  d-block" src="<?php echo base_url().'assets/images/main-logo.png' ?>" style="width: 200px;"/>
                    <h5 class="text-muted font-weight-normal mb-4 mt-5">Silahkan Login</h5>
                    <div id="message">
                    ...
                    <form class="forms-sample" method="post" autocomplete="off" action="<?php echo site_url('login/aksi_login') ?>">
					  ...
					  <div class="g-recaptcha" data-sitekey="6LfC7q8dAAAAAIaKaSb6h4fsEUzC09sn2yhJa5Ul"></div>
                      <div class="mt-3">
                        <button type="submit" class="btn btn-primary mr-2 mb-2 mb-md-0 text-white btn-block">Login</button>
                      </div>
					  <div class="d-flex mt-1">
							<div class="ml-auto">
								<a href="<?php echo site_url('login/reset') ?>" style="color:#000;">Lupa password?</a>
							</div>
						</div>
                    </form>
                  </div>
