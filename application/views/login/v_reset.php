...
<head>
  ...
  <link rel="icon" href="<?php echo base_url() ?>assets/images/favicon.ico.png" type="image/x-icon"> -->
								...
								<div class="col-md-12 pl-md-0">
									<?php 
										...
										<div class="auth-form-wrapper px-5 py-5">
											...
											<h5 class="text-muted font-weight-normal mb-4 mt-3">Reset Password</h5>
											<div id="message">
												<?php echo $this->session->userdata('message') <> '' ? $this->session->userdata('message') : ''; ?>
											</div>
											<form id="reg-form" class="forms-sample needs-validation" method="post" action="<?php echo site_url('login/aksi_reset') ?>" novalidate>
											<div class="form-group">
												<label for="exampleInputEmail1">Silahkan isi dengan email yang sudah terdaftar.</label>
												<input type="email" class="form-control" name="f_email"  placeholder="Email" required>
											</div>
											<div class="mt-3">
												<button type="submit" class="btn btn-primary mr-2 mb-2 mb-md-0 text-white btn-block submitBtn">Reset</button>
											</div>
											<br>
									...
									?>
											<div class="auth-form-wrapper px-5 py-5">
											<h5 class="text-muted font-weight-normal mb-4 mt-3">Berhasil!</h5>
											<p><h6>Link reset password telah terkirim ke email anda. Silahkan cek kotak masuk atau folder Spam</h6></p>
											<br>
												<p>Sudah punya akun? <a href="<?php echo site_url('login') ?>">Login</a></p>
											</form>
										</div>
