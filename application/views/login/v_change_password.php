										...
										<div class="auth-form-wrapper px-5 py-5">
											...
											<div class="form-group">
												...
												<div class="input-group date datepicker">
													<input type="password" id="password" placeholder="Password" class="form-control pwd" name="f_password" required><span class="input-group-addon reveal"><i data-feather="sun"></i></span>
												</div><br>
