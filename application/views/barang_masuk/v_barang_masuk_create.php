					...
					<table id="dataTable1" class="table table-hover w-100">
						...
						<tbody>
							...
							?>
								<tr>
									<td>
										<a href="<?php echo site_url('barang_masuk/list_product/'.$data->id_barang_keluar) ?>" type="button" class="btn btn-info" data-tooltip="tooltip" title="Tambah Barang Masuk">
